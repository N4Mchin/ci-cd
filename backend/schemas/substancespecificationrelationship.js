...
module.exports = class SubstanceSpecificationRelationship {
  ...
  toJSON() {
    return {
      ...
      substanceReference:
        this.substanceReference && this.substanceReference.toJSON(),
      substanceCodeableConcept:
        this.substanceCodeableConcept && this.substanceCodeableConcept.toJSON(),
      ...
      amountRatioLowLimit:
        this.amountRatioLowLimit && this.amountRatioLowLimit.toJSON(),

...
module.exports = class DiagnosticReport {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'resultsInterpreter', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.resultsInterpreter = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'result', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.result = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'imagingStudy', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.imagingStudy = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'media', {
      ...
      set: value => {
        ...
        this.__data.media = Array.isArray(value)
          ? value.map(v => new DiagnosticReportMedia(v))
          : [new DiagnosticReportMedia(value)]
      },
    })
    ...
    Object.defineProperty(this, 'conclusionCode', {
      ...
      set: value => {
        ...
        let CodeableConcept = require('./codeableconcept.js')
        this.__data.conclusionCode = Array.isArray(value)
          ? value.map(v => new CodeableConcept(v))
          : [new CodeableConcept(value)]
      },
    })
    ...
    Object.defineProperty(this, 'presentedForm', {
      ...
      set: value => {
        ...
        this.__data.presentedForm = Array.isArray(value)
  ...
  toJSON() {
    return {
      ...
      _effectiveDateTime:
        this._effectiveDateTime && this._effectiveDateTime.toJSON(),
      ...
      resultsInterpreter:
        this.resultsInterpreter && this.resultsInterpreter.map(v => v.toJSON()),
      ...
      conclusionCode:
        this.conclusionCode && this.conclusionCode.map(v => v.toJSON()),
      presentedForm:
        this.presentedForm && this.presentedForm.map(v => v.toJSON()),
    }
  }
}

...
module.exports = class ClinicalImpression {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'problem', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.problem = Array.isArray(value)
    ...
    Object.defineProperty(this, 'protocol', {
      ...
      set: value => {
        ...
        this.__data.protocol = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      investigation:
        this.investigation && this.investigation.map(v => v.toJSON()),
      ...
      prognosisCodeableConcept:
        ...
        this.prognosisCodeableConcept.map(v => v.toJSON()),
      prognosisReference:
        this.prognosisReference && this.prognosisReference.map(v => v.toJSON()),
      supportingInfo:

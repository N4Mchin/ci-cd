  ...
  toJSON() {
    return {
      ...
      udiDeviceIdentifier:
        ...
        this.udiDeviceIdentifier.map(v => v.toJSON()),
      _manufacturerString:
        this._manufacturerString && this._manufacturerString.toJSON(),
      manufacturerString: this.manufacturerString,
      manufacturerReference:
        this.manufacturerReference && this.manufacturerReference.toJSON(),
      ...
      specialization:
        this.specialization && this.specialization.map(v => v.toJSON()),
      ...
      url: this.url,
      _onlineInformation:
        this._onlineInformation && this._onlineInformation.toJSON(),

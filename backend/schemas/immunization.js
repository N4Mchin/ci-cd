...
module.exports = class Immunization {
  ...
  toJSON() {
    return {
      ...
      _occurrenceString:
        this._occurrenceString && this._occurrenceString.toJSON(),
      ...
      subpotentReason:
        this.subpotentReason && this.subpotentReason.map(v => v.toJSON()),
      education: this.education && this.education.map(v => v.toJSON()),
      programEligibility:
        this.programEligibility && this.programEligibility.map(v => v.toJSON()),
      fundingSource: this.fundingSource && this.fundingSource.toJSON(),
      reaction: this.reaction && this.reaction.map(v => v.toJSON()),
      protocolApplied:
        this.protocolApplied && this.protocolApplied.map(v => v.toJSON()),
    }
  }
}

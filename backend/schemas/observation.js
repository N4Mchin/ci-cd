...
module.exports = class Observation {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'hasMember', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.hasMember = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'derivedFrom', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.derivedFrom = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _effectiveInstant:
        this._effectiveInstant && this._effectiveInstant.toJSON(),
      ...
      interpretation:
        this.interpretation && this.interpretation.map(v => v.toJSON()),
      ...
      referenceRange:
        this.referenceRange && this.referenceRange.map(v => v.toJSON()),

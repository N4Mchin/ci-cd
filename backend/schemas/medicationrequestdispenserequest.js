  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'initialFill', {
      ...
      set: value => {
        ...
        this.__data.initialFill = new MedicationRequestDispenseRequestInitialFill(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      _numberOfRepeatsAllowed:
        this._numberOfRepeatsAllowed && this._numberOfRepeatsAllowed.toJSON(),
      numberOfRepeatsAllowed: this.numberOfRepeatsAllowed,
      quantity: this.quantity && this.quantity.toJSON(),
      expectedSupplyDuration:
        this.expectedSupplyDuration && this.expectedSupplyDuration.toJSON(),

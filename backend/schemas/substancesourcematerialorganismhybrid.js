...
module.exports = class SubstanceSourceMaterialOrganismHybrid {
  ...
  toJSON() {
    return {
      ...
      _maternalOrganismId:
        this._maternalOrganismId && this._maternalOrganismId.toJSON(),
      maternalOrganismId: this.maternalOrganismId,
      _maternalOrganismName:
        this._maternalOrganismName && this._maternalOrganismName.toJSON(),
      maternalOrganismName: this.maternalOrganismName,
      _paternalOrganismId:
        this._paternalOrganismId && this._paternalOrganismId.toJSON(),
      paternalOrganismId: this.paternalOrganismId,
      _paternalOrganismName:
        this._paternalOrganismName && this._paternalOrganismName.toJSON(),

...
module.exports = class Appointment {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'slot', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.slot = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'requestedPeriod', {
      ...
      set: value => {
        ...
        this.__data.requestedPeriod = Array.isArray(value)
          ? value.map(v => new Period(v))
          : [new Period(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      status: this.status,
      cancelationReason:
        this.cancelationReason && this.cancelationReason.toJSON(),
      serviceCategory:
        this.serviceCategory && this.serviceCategory.map(v => v.toJSON()),
      ...
      requestedPeriod:
        this.requestedPeriod && this.requestedPeriod.map(v => v.toJSON()),
    }
  }
}

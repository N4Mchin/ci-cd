    ...
    Object.defineProperty(this, 'molecularWeight', {
      ...
      set: value => {
        ...
        this.__data.molecularWeight = Array.isArray(value)
          ? value.map(
              v => new SubstanceSpecificationStructureIsotopeMolecularWeight(v)
            )
  ...
  toJSON() {
    return {
      ...
      referenceInformation:
        this.referenceInformation && this.referenceInformation.toJSON(),
      structure: this.structure && this.structure.toJSON(),
      code: this.code && this.code.map(v => v.toJSON()),
      name: this.name && this.name.map(v => v.toJSON()),
      molecularWeight:
        this.molecularWeight && this.molecularWeight.map(v => v.toJSON()),

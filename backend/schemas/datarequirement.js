  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'mustSupport', {
      ...
      set: value => {
        ...
        this.__data.mustSupport = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'codeFilter', {
      ...
      set: value => {
        ...
        let Element = require('./element.js')
        this.__data.codeFilter = Array.isArray(value)
    ...
    Object.defineProperty(this, 'dateFilter', {
      ...
      set: value => {
        ...
        let Element = require('./element.js')
        this.__data.dateFilter = Array.isArray(value)
          ? value.map(v => new Element(v))
          : [new Element(value)]
      },
    })
    ...
    Object.defineProperty(this, 'sort', {
      ...
      set: value => {
        ...
        let Element = require('./element.js')
        this.__data.sort = Array.isArray(value)
          ? value.map(v => new Element(v))
          : [new Element(value)]
      },
    })

...
module.exports = class EffectEvidenceSynthesis {
  ...
  toJSON() {
    return {
      ...
      exposureAlternative:
        this.exposureAlternative && this.exposureAlternative.toJSON(),
      outcome: this.outcome && this.outcome.toJSON(),
      sampleSize: this.sampleSize && this.sampleSize.toJSON(),
      resultsByExposure:
        this.resultsByExposure && this.resultsByExposure.map(v => v.toJSON()),
      effectEstimate:
        this.effectEstimate && this.effectEstimate.map(v => v.toJSON()),

...
module.exports = class MedicinalProductPackagedPackageItem {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'device', {
      ...
      set: value => {
        ...
        this.__data.device = Array.isArray(value)
    ...
    Object.defineProperty(this, 'manufacturedItem', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.manufacturedItem = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'manufacturer', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.manufacturer = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      alternateMaterial:
        this.alternateMaterial && this.alternateMaterial.map(v => v.toJSON()),
      device: this.device && this.device.map(v => v.toJSON()),
      manufacturedItem:
        this.manufacturedItem && this.manufacturedItem.map(v => v.toJSON()),
      packageItem: this.packageItem && this.packageItem.map(v => v.toJSON()),
      physicalCharacteristics:
        this.physicalCharacteristics && this.physicalCharacteristics.toJSON(),
      otherCharacteristics:
        this.otherCharacteristics &&
        this.otherCharacteristics.map(v => v.toJSON()),
      shelfLifeStorage:
        this.shelfLifeStorage && this.shelfLifeStorage.map(v => v.toJSON()),

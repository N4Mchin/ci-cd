...
module.exports = class Evidence {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'exposureVariant', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.exposureVariant = Array.isArray(value)
    ...
    Object.defineProperty(this, 'outcome', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.outcome = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      exposureBackground:
        this.exposureBackground && this.exposureBackground.toJSON(),
      exposureVariant:
        this.exposureVariant && this.exposureVariant.map(v => v.toJSON()),

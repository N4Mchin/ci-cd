    ...
    Object.defineProperty(this, 'benefit', {
      ...
      set: value => {
        ...
        this.__data.benefit = Array.isArray(value)
          ? value.map(
              v => new CoverageEligibilityResponseInsuranceItemBenefit(v)
            )
  ...
  toJSON() {
    return {
      ...
      _authorizationRequired:
        this._authorizationRequired && this._authorizationRequired.toJSON(),
      authorizationRequired: this.authorizationRequired,
      authorizationSupporting:
        this.authorizationSupporting &&
        this.authorizationSupporting.map(v => v.toJSON()),
      _authorizationUrl:
        this._authorizationUrl && this._authorizationUrl.toJSON(),

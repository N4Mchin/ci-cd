...
module.exports = class VisionPrescription {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'lensSpecification', {
      ...
      set: value => {
        ...
        this.__data.lensSpecification = Array.isArray(value)
          ? value.map(v => new VisionPrescriptionLensSpecification(v))
          : [new VisionPrescriptionLensSpecification(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      lensSpecification:
        this.lensSpecification && this.lensSpecification.map(v => v.toJSON()),
    }
  }
}

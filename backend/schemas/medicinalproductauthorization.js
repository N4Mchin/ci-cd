  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'jurisdictionalAuthorization', {
      ...
      set: value => {
        ...
        this.__data.jurisdictionalAuthorization = Array.isArray(value)
          ? value.map(
              v =>
                new MedicinalProductAuthorizationJurisdictionalAuthorization(v)
            )
          : [
              new MedicinalProductAuthorizationJurisdictionalAuthorization(
                value
              ),
            ]
      },
    ...
    Object.defineProperty(this, 'procedure', {
      ...
      set: value => {
        ...
        this.__data.procedure = new MedicinalProductAuthorizationProcedure(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      dataExclusivityPeriod:
        this.dataExclusivityPeriod && this.dataExclusivityPeriod.toJSON(),
      _dateOfFirstAuthorization:
        this._dateOfFirstAuthorization &&
        this._dateOfFirstAuthorization.toJSON(),
      dateOfFirstAuthorization: this.dateOfFirstAuthorization,
      _internationalBirthDate:
        this._internationalBirthDate && this._internationalBirthDate.toJSON(),
      ...
      jurisdictionalAuthorization:
        ...
        this.jurisdictionalAuthorization.map(v => v.toJSON()),

...
module.exports = class Procedure {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'report', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.report = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'usedReference', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.usedReference = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _performedDateTime:
        this._performedDateTime && this._performedDateTime.toJSON(),

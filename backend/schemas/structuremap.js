  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'structure', {
      ...
      set: value => {
        ...
        this.__data.structure = Array.isArray(value)
          ? value.map(v => new StructureMapStructure(v))
          : [new StructureMapStructure(value)]
      },
    })
    ...
    Object.defineProperty(this, 'group', {
      ...
      set: value => {
        ...
        this.__data.group = Array.isArray(value)
          ? value.map(v => new StructureMapGroup(v))
          : [new StructureMapGroup(value)]
      },
    })

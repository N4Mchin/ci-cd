...
module.exports = class SubstanceProteinSubunit {
  ...
  toJSON() {
    return {
      ...
      length: this.length,
      sequenceAttachment:
        this.sequenceAttachment && this.sequenceAttachment.toJSON(),
      nTerminalModificationId:
        this.nTerminalModificationId && this.nTerminalModificationId.toJSON(),
      _nTerminalModification:
        this._nTerminalModification && this._nTerminalModification.toJSON(),
      nTerminalModification: this.nTerminalModification,
      cTerminalModificationId:
        this.cTerminalModificationId && this.cTerminalModificationId.toJSON(),
      _cTerminalModification:
        this._cTerminalModification && this._cTerminalModification.toJSON(),

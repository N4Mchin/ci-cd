    ...
    Object.defineProperty(this, 'routeOfAdministration', {
      ...
      set: value => {
        ...
        this.__data.routeOfAdministration = Array.isArray(value)
          ? value.map(
              v => new MedicinalProductPharmaceuticalRouteOfAdministration(v)
            )
  ...
  toJSON() {
    return {
      ...
      administrableDoseForm:
        this.administrableDoseForm && this.administrableDoseForm.toJSON(),
      unitOfPresentation:
        this.unitOfPresentation && this.unitOfPresentation.toJSON(),
      ingredient: this.ingredient && this.ingredient.map(v => v.toJSON()),
      device: this.device && this.device.map(v => v.toJSON()),
      characteristics:
        this.characteristics && this.characteristics.map(v => v.toJSON()),
      routeOfAdministration:
        this.routeOfAdministration &&
        this.routeOfAdministration.map(v => v.toJSON()),
    }
  }
}

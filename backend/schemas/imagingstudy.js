...
module.exports = class ImagingStudy {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'modality', {
      ...
      set: value => {
        ...
        this.__data.modality = Array.isArray(value)
    ...
    Object.defineProperty(this, 'interpreter', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.interpreter = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _numberOfInstances:
        this._numberOfInstances && this._numberOfInstances.toJSON(),
      numberOfInstances: this.numberOfInstances,
      procedureReference:
        this.procedureReference && this.procedureReference.toJSON(),
      procedureCode:
        this.procedureCode && this.procedureCode.map(v => v.toJSON()),

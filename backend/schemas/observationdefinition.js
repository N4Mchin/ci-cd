...
module.exports = class ObservationDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'permittedDataType', {
      ...
      set: value => {
        ...
        this.__data.permittedDataType = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'quantitativeDetails', {
      ...
      set: value => {
        ...
        this.__data.quantitativeDetails = new ObservationDefinitionQuantitativeDetails(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      _permittedDataType:
        this._permittedDataType && this._permittedDataType.toJSON(),
      permittedDataType: this.permittedDataType,
      _multipleResultsAllowed:
        this._multipleResultsAllowed && this._multipleResultsAllowed.toJSON(),
      multipleResultsAllowed: this.multipleResultsAllowed,
      method: this.method && this.method.toJSON(),
      _preferredReportName:
        this._preferredReportName && this._preferredReportName.toJSON(),
      preferredReportName: this.preferredReportName,
      quantitativeDetails:
        this.quantitativeDetails && this.quantitativeDetails.toJSON(),
      qualifiedInterval:
        this.qualifiedInterval && this.qualifiedInterval.map(v => v.toJSON()),
      validCodedValueSet:
        this.validCodedValueSet && this.validCodedValueSet.toJSON(),
      normalCodedValueSet:
        this.normalCodedValueSet && this.normalCodedValueSet.toJSON(),
      abnormalCodedValueSet:
        this.abnormalCodedValueSet && this.abnormalCodedValueSet.toJSON(),
      criticalCodedValueSet:
        this.criticalCodedValueSet && this.criticalCodedValueSet.toJSON(),
    }
  }
}

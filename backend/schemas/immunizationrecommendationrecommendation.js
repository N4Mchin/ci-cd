    ...
    Object.defineProperty(this, 'dateCriterion', {
      ...
      set: value => {
        ...
        this.__data.dateCriterion = Array.isArray(value)
          ? value.map(
              v => new ImmunizationRecommendationRecommendationDateCriterion(v)
            )
  ...
  toJSON() {
    return {
      ...
      contraindicatedVaccineCode:
        ...
        this.contraindicatedVaccineCode.map(v => v.toJSON()),
      forecastStatus: this.forecastStatus && this.forecastStatus.toJSON(),
      forecastReason:
        this.forecastReason && this.forecastReason.map(v => v.toJSON()),
      dateCriterion:
        this.dateCriterion && this.dateCriterion.map(v => v.toJSON()),
      _description: this._description && this._description.toJSON(),
      description: this.description,
      _series: this._series && this._series.toJSON(),
      series: this.series,
      _doseNumberPositiveInt:
        this._doseNumberPositiveInt && this._doseNumberPositiveInt.toJSON(),
      doseNumberPositiveInt: this.doseNumberPositiveInt,
      _doseNumberString:
        this._doseNumberString && this._doseNumberString.toJSON(),
      doseNumberString: this.doseNumberString,
      _seriesDosesPositiveInt:
        this._seriesDosesPositiveInt && this._seriesDosesPositiveInt.toJSON(),
      seriesDosesPositiveInt: this.seriesDosesPositiveInt,
      _seriesDosesString:
        this._seriesDosesString && this._seriesDosesString.toJSON(),
      seriesDosesString: this.seriesDosesString,
      supportingImmunization:
        this.supportingImmunization &&
        this.supportingImmunization.map(v => v.toJSON()),
      supportingPatientInformation:
        this.supportingPatientInformation &&
        this.supportingPatientInformation.map(v => v.toJSON()),
    }
  }
}

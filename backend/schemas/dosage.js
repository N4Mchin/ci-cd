  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'doseAndRate', {
      ...
      set: value => {
        ...
        this.__data.doseAndRate = Array.isArray(value)
          ? value.map(v => new DosageDoseAndRate(v))
          : [new DosageDoseAndRate(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      additionalInstruction:
        ...
        this.additionalInstruction.map(v => v.toJSON()),
      _patientInstruction:
      ...
      maxDosePerAdministration:
        this.maxDosePerAdministration && this.maxDosePerAdministration.toJSON(),
      maxDosePerLifetime:
        this.maxDosePerLifetime && this.maxDosePerLifetime.toJSON(),
    }
  }
}

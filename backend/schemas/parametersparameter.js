...
module.exports = class ParametersParameter {
  ...
  toJSON() {
    return {
      ...
      name: this.name,
      _valueBase64Binary:
        this._valueBase64Binary && this._valueBase64Binary.toJSON(),
      ...
      _valuePositiveInt:
        this._valuePositiveInt && this._valuePositiveInt.toJSON(),
      ...
      _valueUnsignedInt:
        this._valueUnsignedInt && this._valueUnsignedInt.toJSON(),
      ...
      valueContactPoint:
        this.valueContactPoint && this.valueContactPoint.toJSON(),
      ...
      valueContactDetail:
        this.valueContactDetail && this.valueContactDetail.toJSON(),
      valueContributor: this.valueContributor && this.valueContributor.toJSON(),
      valueDataRequirement:
        this.valueDataRequirement && this.valueDataRequirement.toJSON(),
      ...
      valueRelatedArtifact:
        this.valueRelatedArtifact && this.valueRelatedArtifact.toJSON(),
      valueTriggerDefinition:
        this.valueTriggerDefinition && this.valueTriggerDefinition.toJSON(),
      valueUsageContext:
        this.valueUsageContext && this.valueUsageContext.toJSON(),

  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'coverageArea', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.coverageArea = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'eligibility', {
      ...
      set: value => {
        ...
        this.__data.eligibility = Array.isArray(value)
          ? value.map(v => new HealthcareServiceEligibility(v))
          : [new HealthcareServiceEligibility(value)]
      },
    })
    ...
    Object.defineProperty(this, 'program', {
      ...
      set: value => {
        ...
        let CodeableConcept = require('./codeableconcept.js')
        this.__data.program = Array.isArray(value)
          ? value.map(v => new CodeableConcept(v))
          : [new CodeableConcept(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      serviceProvisionCode:
        ...
        this.serviceProvisionCode.map(v => v.toJSON()),
      eligibility: this.eligibility && this.eligibility.map(v => v.toJSON()),
      program: this.program && this.program.map(v => v.toJSON()),
      characteristic:
        this.characteristic && this.characteristic.map(v => v.toJSON()),
      communication:
        this.communication && this.communication.map(v => v.toJSON()),
      referralMethod:
        this.referralMethod && this.referralMethod.map(v => v.toJSON()),
      _appointmentRequired:
        this._appointmentRequired && this._appointmentRequired.toJSON(),
      appointmentRequired: this.appointmentRequired,
      availableTime:
        this.availableTime && this.availableTime.map(v => v.toJSON()),

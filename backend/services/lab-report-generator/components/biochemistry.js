...
const TITLE = 'Biochemistry test'
const TEST_PROTOCOL = 'М-ЭТ-001'
const SAMPLE_TYPE = 'Serum'

const ASSAY_METHOD = 'Colorimetric assay'

const INSTRUMENT_NAME = 'Erba, XL-200 full automatic analyzer'

...
const TITLE = 'Coagulation test'
const TEST_PROTOCOL = 'М-ЭТ-028'
const SAMPLE_TYPE = 'Serum'
const ASSAY_METHOD = 'Clotting, Immuno-turbidimetric, Chromogenic assay'
const INSTRUMENT_NAME = 'Erba, ECL-412 semi-automated coagulometer'

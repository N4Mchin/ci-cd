...
const TITLE = 'SARS CoV-2 (КОВИД-19) вирүсийн эсрэг иммунглобулин G тодорхойлох'
const TEST_PROTOCOL = 'М-ЭТ-013'
const SAMPLE_TYPE = 'Serum'
const ASSAY_METHOD = 'Ферментээр тодорхойлох флюресцент шинжилгээ'
const INSTRUMENT_NAME = 'BIOMERIEUX MINI VIDAS 3'
...
module.exports = (params, writeStream) => {
  ...
  const related = controller.getRelatedReferenceRange(
    LabTests.UncategorizedTests.OtherTests.include.Sars_Cov2_IgG.referenceRange,
    patient
  )

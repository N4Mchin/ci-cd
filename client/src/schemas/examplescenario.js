  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'actor', {
      ...
      set: value => {
        ...
        this.__data.actor = Array.isArray(value)
          ? value.map(v => new ExampleScenarioActor(v))
          : [new ExampleScenarioActor(value)]
      },
    })
    ...
    Object.defineProperty(this, 'instance', {
      ...
      set: value => {
        ...
        this.__data.instance = Array.isArray(value)
          ? value.map(v => new ExampleScenarioInstance(v))
          : [new ExampleScenarioInstance(value)]
      },
    })
    ...
    Object.defineProperty(this, 'workflow', {
      ...
      set: value => {
        ...
        this.__data.workflow = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })

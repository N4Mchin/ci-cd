...
module.exports = class ActivityDefinition {
  ...
  toJSON() {
    return {
      ...
      relatedArtifact:
        this.relatedArtifact && this.relatedArtifact.map(v => v.toJSON()),
      ...
      specimenRequirement:
        ...
        this.specimenRequirement.map(v => v.toJSON()),
      observationRequirement:
        this.observationRequirement &&
        this.observationRequirement.map(v => v.toJSON()),
      observationResultRequirement:
        this.observationResultRequirement &&
        this.observationResultRequirement.map(v => v.toJSON()),

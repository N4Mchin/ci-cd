...
module.exports = class RiskEvidenceSynthesisRiskEstimate {
    ...
    Object.defineProperty(this, 'precisionEstimate', {
      ...
      set: value => {
        ...
        this.__data.precisionEstimate = Array.isArray(value)
          ? value.map(
              v => new RiskEvidenceSynthesisRiskEstimatePrecisionEstimate(v)
            )
  ...
  toJSON() {
    return {
      ...
      _denominatorCount:
        this._denominatorCount && this._denominatorCount.toJSON(),
      ...
      precisionEstimate:
        this.precisionEstimate && this.precisionEstimate.map(v => v.toJSON()),
    }
  }
}

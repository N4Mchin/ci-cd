...
module.exports = class PractitionerRoleAvailableTime {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'daysOfWeek', {
      ...
      set: value => {
        ...
        this.__data.daysOfWeek = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      allDay: this.allDay,
      _availableStartTime:
        this._availableStartTime && this._availableStartTime.toJSON(),
      availableStartTime: this.availableStartTime,
      _availableEndTime:
        this._availableEndTime && this._availableEndTime.toJSON(),

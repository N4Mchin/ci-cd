...
module.exports = class Goal {
    ...
    Object.defineProperty(this, 'target', {
      ...
      set: value => {
        ...
        this.__data.target = Array.isArray(value)
          ? value.map(v => new GoalTarget(v))
          : [new GoalTarget(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      achievementStatus:
        this.achievementStatus && this.achievementStatus.toJSON(),
      ...
      startCodeableConcept:
        this.startCodeableConcept && this.startCodeableConcept.toJSON(),
      ...
      outcomeReference:
        this.outcomeReference && this.outcomeReference.map(v => v.toJSON()),
    }
  }
}

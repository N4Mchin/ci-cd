  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'defaultValueParameterDefinition', {
      ...
      set: value => {
        ...
        this.__data.defaultValueParameterDefinition = new ParameterDefinition(
          value
        )
      },
    })
    ...
    Object.defineProperty(this, 'example', {
      ...
      set: value => {
        ...
        let Element = require('./element.js')
        this.__data.example = Array.isArray(value)
          ? value.map(v => new Element(v))
          : [new Element(value)]
      },
    })
    ...
    Object.defineProperty(this, 'constraint', {
      ...
      set: value => {
        ...
        let Element = require('./element.js')
        this.__data.constraint = Array.isArray(value)
          ? value.map(v => new Element(v))
          : [new Element(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _sliceIsConstraining:
        this._sliceIsConstraining && this._sliceIsConstraining.toJSON(),
      ...
      _contentReference:
        this._contentReference && this._contentReference.toJSON(),
      contentReference: this.contentReference,
      type: this.type && this.type.map(v => v.toJSON()),
      _defaultValueBase64Binary:
        this._defaultValueBase64Binary &&
        this._defaultValueBase64Binary.toJSON(),
      defaultValueBase64Binary: this.defaultValueBase64Binary,
      _defaultValueBoolean:
        this._defaultValueBoolean && this._defaultValueBoolean.toJSON(),
      defaultValueBoolean: this.defaultValueBoolean,
      _defaultValueCanonical:
        this._defaultValueCanonical && this._defaultValueCanonical.toJSON(),
      defaultValueCanonical: this.defaultValueCanonical,
      _defaultValueCode:
        this._defaultValueCode && this._defaultValueCode.toJSON(),
      defaultValueCode: this.defaultValueCode,
      _defaultValueDate:
        this._defaultValueDate && this._defaultValueDate.toJSON(),
      defaultValueDate: this.defaultValueDate,
      _defaultValueDateTime:
        this._defaultValueDateTime && this._defaultValueDateTime.toJSON(),
      defaultValueDateTime: this.defaultValueDateTime,
      _defaultValueDecimal:
        this._defaultValueDecimal && this._defaultValueDecimal.toJSON(),
      ...
      _defaultValueInstant:
        this._defaultValueInstant && this._defaultValueInstant.toJSON(),
      defaultValueInstant: this.defaultValueInstant,
      _defaultValueInteger:
        this._defaultValueInteger && this._defaultValueInteger.toJSON(),
      defaultValueInteger: this.defaultValueInteger,
      _defaultValueMarkdown:
        this._defaultValueMarkdown && this._defaultValueMarkdown.toJSON(),
      ...
      _defaultValuePositiveInt:
        this._defaultValuePositiveInt && this._defaultValuePositiveInt.toJSON(),
      defaultValuePositiveInt: this.defaultValuePositiveInt,
      _defaultValueString:
        this._defaultValueString && this._defaultValueString.toJSON(),
      defaultValueString: this.defaultValueString,
      _defaultValueTime:
        this._defaultValueTime && this._defaultValueTime.toJSON(),
      defaultValueTime: this.defaultValueTime,
      _defaultValueUnsignedInt:
        this._defaultValueUnsignedInt && this._defaultValueUnsignedInt.toJSON(),
      ...
      _defaultValueUuid:
        this._defaultValueUuid && this._defaultValueUuid.toJSON(),
      defaultValueUuid: this.defaultValueUuid,
      defaultValueAddress:
        this.defaultValueAddress && this.defaultValueAddress.toJSON(),
      defaultValueAge: this.defaultValueAge && this.defaultValueAge.toJSON(),
      defaultValueAnnotation:
        this.defaultValueAnnotation && this.defaultValueAnnotation.toJSON(),
      defaultValueAttachment:
        this.defaultValueAttachment && this.defaultValueAttachment.toJSON(),
      defaultValueCodeableConcept:
        this.defaultValueCodeableConcept &&
        this.defaultValueCodeableConcept.toJSON(),
      defaultValueCoding:
        this.defaultValueCoding && this.defaultValueCoding.toJSON(),
      defaultValueContactPoint:
        this.defaultValueContactPoint && this.defaultValueContactPoint.toJSON(),
      defaultValueCount:
        this.defaultValueCount && this.defaultValueCount.toJSON(),
      defaultValueDistance:
        this.defaultValueDistance && this.defaultValueDistance.toJSON(),
      defaultValueDuration:
        this.defaultValueDuration && this.defaultValueDuration.toJSON(),
      defaultValueHumanName:
        this.defaultValueHumanName && this.defaultValueHumanName.toJSON(),
      defaultValueIdentifier:
        this.defaultValueIdentifier && this.defaultValueIdentifier.toJSON(),
      defaultValueMoney:
        this.defaultValueMoney && this.defaultValueMoney.toJSON(),
      defaultValuePeriod:
        this.defaultValuePeriod && this.defaultValuePeriod.toJSON(),
      defaultValueQuantity:
        this.defaultValueQuantity && this.defaultValueQuantity.toJSON(),
      defaultValueRange:
        this.defaultValueRange && this.defaultValueRange.toJSON(),
      defaultValueRatio:
        this.defaultValueRatio && this.defaultValueRatio.toJSON(),
      defaultValueReference:
        this.defaultValueReference && this.defaultValueReference.toJSON(),
      defaultValueSampledData:
        this.defaultValueSampledData && this.defaultValueSampledData.toJSON(),
      defaultValueSignature:
        this.defaultValueSignature && this.defaultValueSignature.toJSON(),
      defaultValueTiming:
        this.defaultValueTiming && this.defaultValueTiming.toJSON(),
      defaultValueContactDetail:
        this.defaultValueContactDetail &&
        this.defaultValueContactDetail.toJSON(),
      defaultValueContributor:
        this.defaultValueContributor && this.defaultValueContributor.toJSON(),
      defaultValueDataRequirement:
        this.defaultValueDataRequirement &&
        this.defaultValueDataRequirement.toJSON(),
      defaultValueExpression:
        this.defaultValueExpression && this.defaultValueExpression.toJSON(),
      defaultValueParameterDefinition:
        this.defaultValueParameterDefinition &&
        this.defaultValueParameterDefinition.toJSON(),
      defaultValueRelatedArtifact:
        this.defaultValueRelatedArtifact &&
        this.defaultValueRelatedArtifact.toJSON(),
      defaultValueTriggerDefinition:
        this.defaultValueTriggerDefinition &&
        this.defaultValueTriggerDefinition.toJSON(),
      defaultValueUsageContext:
        this.defaultValueUsageContext && this.defaultValueUsageContext.toJSON(),
      defaultValueDosage:
        this.defaultValueDosage && this.defaultValueDosage.toJSON(),
      _meaningWhenMissing:
        this._meaningWhenMissing && this._meaningWhenMissing.toJSON(),
      ...
      _fixedBase64Binary:
        this._fixedBase64Binary && this._fixedBase64Binary.toJSON(),
      ...
      _fixedPositiveInt:
        this._fixedPositiveInt && this._fixedPositiveInt.toJSON(),
      ...
      _fixedUnsignedInt:
        this._fixedUnsignedInt && this._fixedUnsignedInt.toJSON(),
      ...
      fixedCodeableConcept:
        this.fixedCodeableConcept && this.fixedCodeableConcept.toJSON(),
      fixedCoding: this.fixedCoding && this.fixedCoding.toJSON(),
      fixedContactPoint:
        this.fixedContactPoint && this.fixedContactPoint.toJSON(),
      ...
      fixedContactDetail:
        this.fixedContactDetail && this.fixedContactDetail.toJSON(),
      fixedContributor: this.fixedContributor && this.fixedContributor.toJSON(),
      fixedDataRequirement:
        this.fixedDataRequirement && this.fixedDataRequirement.toJSON(),
      fixedExpression: this.fixedExpression && this.fixedExpression.toJSON(),
      fixedParameterDefinition:
        this.fixedParameterDefinition && this.fixedParameterDefinition.toJSON(),
      fixedRelatedArtifact:
        this.fixedRelatedArtifact && this.fixedRelatedArtifact.toJSON(),
      fixedTriggerDefinition:
        this.fixedTriggerDefinition && this.fixedTriggerDefinition.toJSON(),
      fixedUsageContext:
        this.fixedUsageContext && this.fixedUsageContext.toJSON(),
      fixedDosage: this.fixedDosage && this.fixedDosage.toJSON(),
      _patternBase64Binary:
        this._patternBase64Binary && this._patternBase64Binary.toJSON(),
      ...
      _patternCanonical:
        this._patternCanonical && this._patternCanonical.toJSON(),
      ...
      _patternPositiveInt:
        this._patternPositiveInt && this._patternPositiveInt.toJSON(),
      ...
      _patternUnsignedInt:
        this._patternUnsignedInt && this._patternUnsignedInt.toJSON(),
      ...
      patternAnnotation:
        this.patternAnnotation && this.patternAnnotation.toJSON(),
      patternAttachment:
        this.patternAttachment && this.patternAttachment.toJSON(),
      patternCodeableConcept:
        this.patternCodeableConcept && this.patternCodeableConcept.toJSON(),
      patternCoding: this.patternCoding && this.patternCoding.toJSON(),
      patternContactPoint:
        this.patternContactPoint && this.patternContactPoint.toJSON(),
      ...
      patternIdentifier:
        this.patternIdentifier && this.patternIdentifier.toJSON(),
      ...
      patternSampledData:
        this.patternSampledData && this.patternSampledData.toJSON(),
      ...
      patternContactDetail:
        this.patternContactDetail && this.patternContactDetail.toJSON(),
      patternContributor:
        this.patternContributor && this.patternContributor.toJSON(),
      patternDataRequirement:
        this.patternDataRequirement && this.patternDataRequirement.toJSON(),
      patternExpression:
        this.patternExpression && this.patternExpression.toJSON(),
      patternParameterDefinition:
        this.patternParameterDefinition &&
        this.patternParameterDefinition.toJSON(),
      patternRelatedArtifact:
        this.patternRelatedArtifact && this.patternRelatedArtifact.toJSON(),
      patternTriggerDefinition:
        this.patternTriggerDefinition && this.patternTriggerDefinition.toJSON(),
      patternUsageContext:
        this.patternUsageContext && this.patternUsageContext.toJSON(),
      ...
      _minValueDateTime:
        this._minValueDateTime && this._minValueDateTime.toJSON(),
      ...
      _minValuePositiveInt:
        this._minValuePositiveInt && this._minValuePositiveInt.toJSON(),
      minValuePositiveInt: this.minValuePositiveInt,
      _minValueUnsignedInt:
        this._minValueUnsignedInt && this._minValueUnsignedInt.toJSON(),
      ...
      _maxValueDateTime:
        this._maxValueDateTime && this._maxValueDateTime.toJSON(),
      ...
      _maxValuePositiveInt:
        this._maxValuePositiveInt && this._maxValuePositiveInt.toJSON(),
      maxValuePositiveInt: this.maxValuePositiveInt,
      _maxValueUnsignedInt:
        this._maxValueUnsignedInt && this._maxValueUnsignedInt.toJSON(),
      ...
      _isModifierReason:
        this._isModifierReason && this._isModifierReason.toJSON(),

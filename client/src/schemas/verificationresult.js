...
module.exports = class VerificationResult {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'targetLocation', {
      ...
      set: value => {
        ...
        this.__data.targetLocation = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      validationProcess:
        this.validationProcess && this.validationProcess.map(v => v.toJSON()),
      ...
      primarySource:
        this.primarySource && this.primarySource.map(v => v.toJSON()),

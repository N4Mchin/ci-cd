  ...
  toJSON() {
    return {
      ...
      _baseFormulaProductName:
        this._baseFormulaProductName && this._baseFormulaProductName.toJSON(),
      ...
      _additiveProductName:
        this._additiveProductName && this._additiveProductName.toJSON(),
      additiveProductName: this.additiveProductName,
      caloricDensity: this.caloricDensity && this.caloricDensity.toJSON(),
      routeofAdministration:
        this.routeofAdministration && this.routeofAdministration.toJSON(),
      administration:
        this.administration && this.administration.map(v => v.toJSON()),
      maxVolumeToDeliver:
        this.maxVolumeToDeliver && this.maxVolumeToDeliver.toJSON(),
      _administrationInstruction:
        this._administrationInstruction &&
        this._administrationInstruction.toJSON(),

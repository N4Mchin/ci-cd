    ...
    Object.defineProperty(this, 'degreeOfPolymerisation', {
      ...
      set: value => {
        ...
        this.__data.degreeOfPolymerisation = Array.isArray(value)
          ? value.map(
              v => new SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(v)
            )
    ...
    Object.defineProperty(this, 'structuralRepresentation', {
      ...
      set: value => {
        ...
        this.__data.structuralRepresentation = Array.isArray(value)
          ? value.map(
              v =>
                new SubstancePolymerRepeatRepeatUnitStructuralRepresentation(v)
            )
          : [
              new SubstancePolymerRepeatRepeatUnitStructuralRepresentation(
                value
              ),
            ]
      },
  ...
  toJSON() {
    return {
      ...
      orientationOfPolymerisation:
        ...
        this.orientationOfPolymerisation.toJSON(),
      ...
      degreeOfPolymerisation:
        ...
        this.degreeOfPolymerisation.map(v => v.toJSON()),
      structuralRepresentation:
        this.structuralRepresentation &&
        this.structuralRepresentation.map(v => v.toJSON()),
    }
  }
}

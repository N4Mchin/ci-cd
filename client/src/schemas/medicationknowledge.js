  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contraindication', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.contraindication = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      relatedMedicationKnowledge:
        ...
        this.relatedMedicationKnowledge.map(v => v.toJSON()),
      associatedMedication:
        this.associatedMedication &&
        this.associatedMedication.map(v => v.toJSON()),
      ...
      _preparationInstruction:
        this._preparationInstruction && this._preparationInstruction.toJSON(),
      preparationInstruction: this.preparationInstruction,
      intendedRoute:
        this.intendedRoute && this.intendedRoute.map(v => v.toJSON()),
      cost: this.cost && this.cost.map(v => v.toJSON()),
      monitoringProgram:
        this.monitoringProgram && this.monitoringProgram.map(v => v.toJSON()),
      administrationGuidelines:
        this.administrationGuidelines &&
        this.administrationGuidelines.map(v => v.toJSON()),
      medicineClassification:
        this.medicineClassification &&
        this.medicineClassification.map(v => v.toJSON()),
      packaging: this.packaging && this.packaging.toJSON(),
      drugCharacteristic:
        this.drugCharacteristic && this.drugCharacteristic.map(v => v.toJSON()),
      contraindication:
        this.contraindication && this.contraindication.map(v => v.toJSON()),

...
module.exports = class ExplanationOfBenefitAddItem {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'itemSequence', {
      ...
      set: value => {
        ...
        this.__data.itemSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'detailSequence', {
      ...
      set: value => {
        ...
        this.__data.detailSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'subDetailSequence', {
      ...
      set: value => {
        ...
        this.__data.subDetailSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'provider', {
      ...
      set: value => {
        ...
        this.__data.provider = Array.isArray(value)
    ...
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        this.__data.detail = Array.isArray(value)
          ? value.map(v => new ExplanationOfBenefitAddItemDetail(v))
          : [new ExplanationOfBenefitAddItemDetail(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _subDetailSequence:
        this._subDetailSequence && this._subDetailSequence.toJSON(),

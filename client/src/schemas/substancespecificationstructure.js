...
module.exports = class SubstanceSpecificationStructure {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'molecularWeight', {
      ...
      set: value => {
        ...
        this.__data.molecularWeight = new SubstanceSpecificationStructureIsotopeMolecularWeight(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      representation:
        this.representation && this.representation.map(v => v.toJSON()),
    }
  }
}

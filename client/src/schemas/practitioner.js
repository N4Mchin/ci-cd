...
module.exports = class Practitioner {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'qualification', {
      ...
      set: value => {
        ...
        this.__data.qualification = Array.isArray(value)
          ? value.map(v => new PractitionerQualification(v))
          : [new PractitionerQualification(value)]
      },
    })
  ...
  getLastName(prefer = 'mn') {
    ...
    return this.name && this.name.find(n => n.family !== undefined).family
  }
  ...
  getEmails() {
    try {
      ...
      const emailAddresses = sortedByRank.map(phone => phone.value)
  ...
  toJSON() {
    return {
      ...
      qualification:
        this.qualification && this.qualification.map(v => v.toJSON()),
      communication:

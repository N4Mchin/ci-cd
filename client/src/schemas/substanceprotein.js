...
module.exports = class SubstanceProtein {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'disulfideLinkage', {
      ...
      set: value => {
        ...
        this.__data.disulfideLinkage = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'subunit', {
      ...
      set: value => {
        ...
        this.__data.subunit = Array.isArray(value)
          ? value.map(v => new SubstanceProteinSubunit(v))
          : [new SubstanceProteinSubunit(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _numberOfSubunits:
        this._numberOfSubunits && this._numberOfSubunits.toJSON(),
      numberOfSubunits: this.numberOfSubunits,
      _disulfideLinkage:
        this._disulfideLinkage && this._disulfideLinkage.toJSON(),

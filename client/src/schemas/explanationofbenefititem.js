...
module.exports = class ExplanationOfBenefitItem {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'careTeamSequence', {
      ...
      set: value => {
        ...
        this.__data.careTeamSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'diagnosisSequence', {
      ...
      set: value => {
        ...
        this.__data.diagnosisSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'procedureSequence', {
      ...
      set: value => {
        ...
        this.__data.procedureSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'informationSequence', {
      ...
      set: value => {
        ...
        this.__data.informationSequence = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'udi', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.udi = Array.isArray(value)
    ...
    Object.defineProperty(this, 'encounter', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.encounter = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'noteNumber', {
      ...
      set: value => {
        ...
        this.__data.noteNumber = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'detail', {
      ...
      set: value => {
        ...
        this.__data.detail = Array.isArray(value)
          ? value.map(v => new ExplanationOfBenefitItemDetail(v))
          : [new ExplanationOfBenefitItemDetail(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _careTeamSequence:
        this._careTeamSequence && this._careTeamSequence.toJSON(),
      careTeamSequence: this.careTeamSequence,
      _diagnosisSequence:
        this._diagnosisSequence && this._diagnosisSequence.toJSON(),
      diagnosisSequence: this.diagnosisSequence,
      _procedureSequence:
        this._procedureSequence && this._procedureSequence.toJSON(),
      procedureSequence: this.procedureSequence,
      _informationSequence:
        this._informationSequence && this._informationSequence.toJSON(),
      ...
      locationCodeableConcept:
        this.locationCodeableConcept && this.locationCodeableConcept.toJSON(),
      locationAddress: this.locationAddress && this.locationAddress.toJSON(),
      locationReference:
        this.locationReference && this.locationReference.toJSON(),

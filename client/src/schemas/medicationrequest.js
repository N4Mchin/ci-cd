...
module.exports = class MedicationRequest {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'instantiatesCanonical', {
      ...
      set: value => {
        ...
        this.__data.instantiatesCanonical = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'instantiatesUri', {
      ...
      set: value => {
        ...
        this.__data.instantiatesUri = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'dispenseRequest', {
      ...
      set: value => {
        ...
        this.__data.dispenseRequest = new MedicationRequestDispenseRequest(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      reportedReference:
        this.reportedReference && this.reportedReference.toJSON(),
      medicationCodeableConcept:
        this.medicationCodeableConcept &&
        this.medicationCodeableConcept.toJSON(),
      medicationReference:
        this.medicationReference && this.medicationReference.toJSON(),
      subject: this.subject && this.subject.toJSON(),
      encounter: this.encounter && this.encounter.toJSON(),
      supportingInformation:
        this.supportingInformation &&
        this.supportingInformation.map(v => v.toJSON()),
      ...
      reasonReference:
        this.reasonReference && this.reasonReference.map(v => v.toJSON()),
      _instantiatesCanonical:
        this._instantiatesCanonical && this._instantiatesCanonical.toJSON(),
      ...
      courseOfTherapyType:
        this.courseOfTherapyType && this.courseOfTherapyType.toJSON(),
      insurance: this.insurance && this.insurance.map(v => v.toJSON()),
      note: this.note && this.note.map(v => v.toJSON()),
      dosageInstruction:
        this.dosageInstruction && this.dosageInstruction.map(v => v.toJSON()),
      dispenseRequest: this.dispenseRequest && this.dispenseRequest.toJSON(),
      substitution: this.substitution && this.substitution.toJSON(),
      priorPrescription:
        this.priorPrescription && this.priorPrescription.toJSON(),
      detectedIssue:
        this.detectedIssue && this.detectedIssue.map(v => v.toJSON()),

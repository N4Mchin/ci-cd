  ...
  toJSON() {
    return {
      ...
      _clinicalRecommendationStatement:
        ...
        this._clinicalRecommendationStatement.toJSON(),
      clinicalRecommendationStatement: this.clinicalRecommendationStatement,
      improvementNotation:
        this.improvementNotation && this.improvementNotation.toJSON(),
      ...
      supplementalData:
        this.supplementalData && this.supplementalData.map(v => v.toJSON()),
    }
  }
}

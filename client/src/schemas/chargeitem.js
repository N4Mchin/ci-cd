  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'definitionUri', {
      ...
      set: value => {
        ...
        this.__data.definitionUri = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'definitionCanonical', {
      ...
      set: value => {
        ...
        this.__data.definitionCanonical = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'service', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.service = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'account', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.account = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      performingOrganization:
        this.performingOrganization && this.performingOrganization.toJSON(),
      requestingOrganization:
        this.requestingOrganization && this.requestingOrganization.toJSON(),
      ...
      productCodeableConcept:
        this.productCodeableConcept && this.productCodeableConcept.toJSON(),

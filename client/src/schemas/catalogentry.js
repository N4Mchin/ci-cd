  ...
  toJSON() {
    return {
      ...
      additionalIdentifier:
        ...
        this.additionalIdentifier.map(v => v.toJSON()),
      classification:
        this.classification && this.classification.map(v => v.toJSON()),
      ...
      additionalCharacteristic:
        ...
        this.additionalCharacteristic.map(v => v.toJSON()),
      additionalClassification:
        this.additionalClassification &&
        this.additionalClassification.map(v => v.toJSON()),

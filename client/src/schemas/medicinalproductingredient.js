  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'specifiedSubstance', {
      ...
      set: value => {
        ...
        this.__data.specifiedSubstance = Array.isArray(value)
          ? value.map(v => new MedicinalProductIngredientSpecifiedSubstance(v))
          : [new MedicinalProductIngredientSpecifiedSubstance(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _allergenicIndicator:
        this._allergenicIndicator && this._allergenicIndicator.toJSON(),
      allergenicIndicator: this.allergenicIndicator,
      manufacturer: this.manufacturer && this.manufacturer.map(v => v.toJSON()),
      specifiedSubstance:
        this.specifiedSubstance && this.specifiedSubstance.map(v => v.toJSON()),

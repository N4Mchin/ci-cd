...
module.exports = class ResearchStudy {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'enrollment', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.enrollment = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      status: this.status,
      primaryPurposeType:
        this.primaryPurposeType && this.primaryPurposeType.toJSON(),
      ...
      principalInvestigator:
        this.principalInvestigator && this.principalInvestigator.toJSON(),

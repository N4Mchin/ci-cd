...
module.exports = class SpecimenCollection {
  ...
  toJSON() {
    return {
      ...
      _collectedDateTime:
        this._collectedDateTime && this._collectedDateTime.toJSON(),
      ...
      fastingStatusCodeableConcept:
        ...
        this.fastingStatusCodeableConcept.toJSON(),
      fastingStatusDuration:
        this.fastingStatusDuration && this.fastingStatusDuration.toJSON(),
    }
  }
}

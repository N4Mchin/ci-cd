    ...
    Object.defineProperty(this, 'targetSpecies', {
      ...
      set: value => {
        ...
        this.__data.targetSpecies = Array.isArray(value)
          ? value.map(
              v =>
                new MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies(
                  v
                )
            )
          : [
  ...
  toJSON() {
    return {
      ...
      maxDosePerTreatmentPeriod:
        ...
        this.maxDosePerTreatmentPeriod.toJSON(),
      maxTreatmentPeriod:
        this.maxTreatmentPeriod && this.maxTreatmentPeriod.toJSON(),
      targetSpecies:
        this.targetSpecies && this.targetSpecies.map(v => v.toJSON()),
    }
  }
}

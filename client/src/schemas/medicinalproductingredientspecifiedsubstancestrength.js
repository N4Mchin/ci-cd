    ...
    Object.defineProperty(this, 'referenceStrength', {
      ...
      set: value => {
        ...
        this.__data.referenceStrength = Array.isArray(value)
          ? value.map(
              v =>
                new MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength(
                  v
                )
            )
          : [
  ...
  toJSON() {
    return {
      ...
      presentationLowLimit:
        this.presentationLowLimit && this.presentationLowLimit.toJSON(),
      concentration: this.concentration && this.concentration.toJSON(),
      concentrationLowLimit:
        this.concentrationLowLimit && this.concentrationLowLimit.toJSON(),
      _measurementPoint:
        this._measurementPoint && this._measurementPoint.toJSON(),
      measurementPoint: this.measurementPoint,
      country: this.country && this.country.map(v => v.toJSON()),
      referenceStrength:
        this.referenceStrength && this.referenceStrength.map(v => v.toJSON()),
    }
  }
}

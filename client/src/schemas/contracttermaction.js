...
module.exports = class ContractTermAction {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'contextLinkId', {
      ...
      set: value => {
        ...
        this.__data.contextLinkId = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'requester', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.requester = Array.isArray(value)
    ...
    Object.defineProperty(this, 'requesterLinkId', {
      ...
      set: value => {
        ...
        this.__data.requesterLinkId = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'performerLinkId', {
      ...
      set: value => {
        ...
        this.__data.performerLinkId = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'reasonLinkId', {
      ...
      set: value => {
        ...
        this.__data.reasonLinkId = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'securityLabelNumber', {
      ...
      set: value => {
        ...
        this.__data.securityLabelNumber = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      performerType:
        this.performerType && this.performerType.map(v => v.toJSON()),
      ...
      _securityLabelNumber:
        this._securityLabelNumber && this._securityLabelNumber.toJSON(),

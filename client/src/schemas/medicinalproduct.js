  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'specialMeasures', {
      ...
      set: value => {
        ...
        this.__data.specialMeasures = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'attachedDocument', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.attachedDocument = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'masterFile', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.masterFile = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'clinicalTrial', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.clinicalTrial = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'crossReference', {
      ...
      set: value => {
        ...
        let Identifier = require('./identifier.js')
        this.__data.crossReference = Array.isArray(value)
          ? value.map(v => new Identifier(v))
          : [new Identifier(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      combinedPharmaceuticalDoseForm:
        ...
        this.combinedPharmaceuticalDoseForm.toJSON(),
      legalStatusOfSupply:
        this.legalStatusOfSupply && this.legalStatusOfSupply.toJSON(),
      additionalMonitoringIndicator:
        this.additionalMonitoringIndicator &&
        this.additionalMonitoringIndicator.toJSON(),
      _specialMeasures: this._specialMeasures && this._specialMeasures.toJSON(),
      specialMeasures: this.specialMeasures,
      paediatricUseIndicator:
        this.paediatricUseIndicator && this.paediatricUseIndicator.toJSON(),
      productClassification:
        this.productClassification &&
        this.productClassification.map(v => v.toJSON()),
      marketingStatus:
        this.marketingStatus && this.marketingStatus.map(v => v.toJSON()),
      pharmaceuticalProduct:
        this.pharmaceuticalProduct &&
        this.pharmaceuticalProduct.map(v => v.toJSON()),
      packagedMedicinalProduct:
        this.packagedMedicinalProduct &&
        this.packagedMedicinalProduct.map(v => v.toJSON()),
      attachedDocument:
        this.attachedDocument && this.attachedDocument.map(v => v.toJSON()),
      masterFile: this.masterFile && this.masterFile.map(v => v.toJSON()),
      contact: this.contact && this.contact.map(v => v.toJSON()),
      clinicalTrial:
        this.clinicalTrial && this.clinicalTrial.map(v => v.toJSON()),
      name: this.name && this.name.map(v => v.toJSON()),
      crossReference:
        this.crossReference && this.crossReference.map(v => v.toJSON()),
      manufacturingBusinessOperation:
        this.manufacturingBusinessOperation &&
        this.manufacturingBusinessOperation.map(v => v.toJSON()),
      specialDesignation:
        this.specialDesignation && this.specialDesignation.map(v => v.toJSON()),
    }
  }
}

...
module.exports = class ServiceRequest {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'specimen', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.specimen = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _occurrenceDateTime:
        this._occurrenceDateTime && this._occurrenceDateTime.toJSON(),
      ...
      asNeededCodeableConcept:
        this.asNeededCodeableConcept && this.asNeededCodeableConcept.toJSON(),
      ...
      locationReference:
        this.locationReference && this.locationReference.map(v => v.toJSON()),
      ...
      _patientInstruction:
        this._patientInstruction && this._patientInstruction.toJSON(),

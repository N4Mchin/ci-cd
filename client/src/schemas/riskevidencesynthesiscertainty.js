    ...
    Object.defineProperty(this, 'certaintySubcomponent', {
      ...
      set: value => {
        ...
        this.__data.certaintySubcomponent = Array.isArray(value)
          ? value.map(
              v => new RiskEvidenceSynthesisCertaintyCertaintySubcomponent(v)
            )
          : [new RiskEvidenceSynthesisCertaintyCertaintySubcomponent(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      certaintySubcomponent:
        ...
        this.certaintySubcomponent.map(v => v.toJSON()),
    }
  }
}

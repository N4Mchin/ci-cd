  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'preAuthRef', {
      ...
      set: value => {
        ...
        this.__data.preAuthRef = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'preAuthRefPeriod', {
      ...
      set: value => {
        ...
        let Period = require('./period.js')
        this.__data.preAuthRefPeriod = Array.isArray(value)
  ...
  toJSON() {
    return {
      ...
      fundsReserveRequested:
        this.fundsReserveRequested && this.fundsReserveRequested.toJSON(),
      ...
      originalPrescription:
        this.originalPrescription && this.originalPrescription.toJSON(),
      ...
      preAuthRefPeriod:
        this.preAuthRefPeriod && this.preAuthRefPeriod.map(v => v.toJSON()),
      ...
      benefitBalance:
        this.benefitBalance && this.benefitBalance.map(v => v.toJSON()),
    }
  }
}

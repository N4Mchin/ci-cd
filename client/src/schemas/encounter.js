...
module.exports = class Encounter {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'episodeOfCare', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.episodeOfCare = Array.isArray(value)
    ...
    Object.defineProperty(this, 'appointment', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.appointment = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      status: this.status,
      statusHistory:
        this.statusHistory && this.statusHistory.map(v => v.toJSON()),
      ...
      episodeOfCare:
        this.episodeOfCare && this.episodeOfCare.map(v => v.toJSON()),

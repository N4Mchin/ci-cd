...
module.exports = class SubstanceSourceMaterial {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'parentSubstanceName', {
      ...
      set: value => {
        ...
        this.__data.parentSubstanceName = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'geographicalLocation', {
      ...
      set: value => {
        ...
        this.__data.geographicalLocation = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      sourceMaterialClass:
        this.sourceMaterialClass && this.sourceMaterialClass.toJSON(),
      sourceMaterialType:
        this.sourceMaterialType && this.sourceMaterialType.toJSON(),
      sourceMaterialState:
        this.sourceMaterialState && this.sourceMaterialState.toJSON(),
      ...
      parentSubstanceId:
        this.parentSubstanceId && this.parentSubstanceId.map(v => v.toJSON()),
      _parentSubstanceName:
        this._parentSubstanceName && this._parentSubstanceName.toJSON(),
      parentSubstanceName: this.parentSubstanceName,
      countryOfOrigin:
        this.countryOfOrigin && this.countryOfOrigin.map(v => v.toJSON()),
      _geographicalLocation:
        this._geographicalLocation && this._geographicalLocation.toJSON(),
      ...
      fractionDescription:
        ...
        this.fractionDescription.map(v => v.toJSON()),
      organism: this.organism && this.organism.toJSON(),
      partDescription:
        this.partDescription && this.partDescription.map(v => v.toJSON()),
    }
  }
}

...
module.exports = class Bundle {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'link', {
      ...
      set: value => {
        ...
        this.__data.link = Array.isArray(value)
          ? value.map(v => new BundleLink(v))
          : [new BundleLink(value)]
      },
    })
    ...
    Object.defineProperty(this, 'entry', {
      ...
      set: value => {
        ...
        this.__data.entry = Array.isArray(value)
          ? value.map(v => new BundleEntry(v))
          : [new BundleEntry(value)]
      },
    })
  ...
  getResourcesOnly() {
    return this.entry
      ...
      .filter(bundleEntry => bundleEntry !== undefined)
  }
}

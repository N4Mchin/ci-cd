...
module.exports = class Patient {
  ...
  _getDlivrIdentificationNumber() {
    try {
      const dlivrIdentificationNumber = this.identifier.find(
        v => v.system === 'http://livercenter.mn/fhir/identifiers/dlivr'
      ).value
      return dlivrIdentificationNumber
    } catch {}
    return
  }
  ...
  _setNationalIdentificationNumber(nationalIdentificationNumberString) {
    ...
    if (ninIndex !== undefined && ninIndex >= 0) {

...
module.exports = class PlanDefinitionAction {
  ...
  toJSON() {
    return {
      ...
      documentation:
        this.documentation && this.documentation.map(v => v.toJSON()),
      _goalId: this._goalId && this._goalId.toJSON(),
      goalId: this.goalId,
      subjectCodeableConcept:
        this.subjectCodeableConcept && this.subjectCodeableConcept.toJSON(),
      ...
      relatedAction:
        this.relatedAction && this.relatedAction.map(v => v.toJSON()),
      ...
      _groupingBehavior:
        this._groupingBehavior && this._groupingBehavior.toJSON(),
      groupingBehavior: this.groupingBehavior,
      _selectionBehavior:
        this._selectionBehavior && this._selectionBehavior.toJSON(),
      selectionBehavior: this.selectionBehavior,
      _requiredBehavior:
        this._requiredBehavior && this._requiredBehavior.toJSON(),
      requiredBehavior: this.requiredBehavior,
      _precheckBehavior:
        this._precheckBehavior && this._precheckBehavior.toJSON(),
      precheckBehavior: this.precheckBehavior,
      _cardinalityBehavior:
        this._cardinalityBehavior && this._cardinalityBehavior.toJSON(),

...
module.exports = class Condition {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'stage', {
      ...
      set: value => {
        ...
        this.__data.stage = Array.isArray(value)
          ? value.map(v => new ConditionStage(v))
          : [new ConditionStage(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      verificationStatus:
        this.verificationStatus && this.verificationStatus.toJSON(),
      ...
      _abatementDateTime:
        this._abatementDateTime && this._abatementDateTime.toJSON(),

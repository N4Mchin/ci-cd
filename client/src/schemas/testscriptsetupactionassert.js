...
module.exports = class TestScriptSetupActionAssert {
  ...
  toJSON() {
    return {
      ...
      _validateProfileId:
        this._validateProfileId && this._validateProfileId.toJSON(),

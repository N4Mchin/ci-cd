...
module.exports = class CapabilityStatementRestResource {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'supportedProfile', {
      ...
      set: value => {
        ...
        this.__data.supportedProfile = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'referencePolicy', {
      ...
      set: value => {
        ...
        this.__data.referencePolicy = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'searchInclude', {
      ...
      set: value => {
        ...
        this.__data.searchInclude = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'searchRevInclude', {
      ...
      set: value => {
        ...
        this.__data.searchRevInclude = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _supportedProfile:
        this._supportedProfile && this._supportedProfile.toJSON(),
      ...
      _conditionalCreate:
        this._conditionalCreate && this._conditionalCreate.toJSON(),
      ...
      _conditionalUpdate:
        this._conditionalUpdate && this._conditionalUpdate.toJSON(),
      conditionalUpdate: this.conditionalUpdate,
      _conditionalDelete:
        this._conditionalDelete && this._conditionalDelete.toJSON(),
      ...
      _searchRevInclude:
        this._searchRevInclude && this._searchRevInclude.toJSON(),

...
module.exports = class SubstanceSourceMaterialOrganism {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'organismGeneral', {
      ...
      set: value => {
        ...
        this.__data.organismGeneral = new SubstanceSourceMaterialOrganismOrganismGeneral(
          value
        )
      },
    })
  ...
  toJSON() {
    return {
      ...
      intraspecificType:
        this.intraspecificType && this.intraspecificType.toJSON(),
      _intraspecificDescription:
        this._intraspecificDescription &&
        this._intraspecificDescription.toJSON(),

  ...
  toJSON() {
    return {
      ...
      definitionCodeableConcept:
        ...
        this.definitionCodeableConcept.toJSON(),
      _definitionCanonical:
        this._definitionCanonical && this._definitionCanonical.toJSON(),
      definitionCanonical: this.definitionCanonical,
      definitionExpression:
        this.definitionExpression && this.definitionExpression.toJSON(),
      definitionDataRequirement:
        this.definitionDataRequirement &&
        this.definitionDataRequirement.toJSON(),
      ...
      _studyEffectiveDescription:
        ...
        this._studyEffectiveDescription.toJSON(),
      studyEffectiveDescription: this.studyEffectiveDescription,
      _studyEffectiveDateTime:
        this._studyEffectiveDateTime && this._studyEffectiveDateTime.toJSON(),
      studyEffectiveDateTime: this.studyEffectiveDateTime,
      studyEffectivePeriod:
        this.studyEffectivePeriod && this.studyEffectivePeriod.toJSON(),
      studyEffectiveDuration:
        this.studyEffectiveDuration && this.studyEffectiveDuration.toJSON(),
      studyEffectiveTiming:
        this.studyEffectiveTiming && this.studyEffectiveTiming.toJSON(),
      studyEffectiveTimeFromStart:
        this.studyEffectiveTimeFromStart &&
        this.studyEffectiveTimeFromStart.toJSON(),
      _studyEffectiveGroupMeasure:
        this._studyEffectiveGroupMeasure &&
        this._studyEffectiveGroupMeasure.toJSON(),
      ...
      _participantEffectiveDescription:
        ...
        this._participantEffectiveDescription.toJSON(),
      ...
      _participantEffectiveDateTime:
        ...
        this._participantEffectiveDateTime.toJSON(),
      participantEffectiveDateTime: this.participantEffectiveDateTime,
      participantEffectivePeriod:
        this.participantEffectivePeriod &&
        this.participantEffectivePeriod.toJSON(),
      participantEffectiveDuration:
        this.participantEffectiveDuration &&
        this.participantEffectiveDuration.toJSON(),
      participantEffectiveTiming:
        this.participantEffectiveTiming &&
        this.participantEffectiveTiming.toJSON(),
      participantEffectiveTimeFromStart:
        this.participantEffectiveTimeFromStart &&
        this.participantEffectiveTimeFromStart.toJSON(),
      _participantEffectiveGroupMeasure:
        this._participantEffectiveGroupMeasure &&
        this._participantEffectiveGroupMeasure.toJSON(),

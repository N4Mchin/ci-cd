...
module.exports = class Location {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'hoursOfOperation', {
      ...
      set: value => {
        ...
        this.__data.hoursOfOperation = Array.isArray(value)
          ? value.map(v => new LocationHoursOfOperation(v))
          : [new LocationHoursOfOperation(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      status: this.status,
      operationalStatus:
        this.operationalStatus && this.operationalStatus.toJSON(),
      ...
      hoursOfOperation:
        this.hoursOfOperation && this.hoursOfOperation.map(v => v.toJSON()),

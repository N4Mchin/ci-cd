...
module.exports = class ContractTermAsset {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'typeReference', {
      ...
      set: value => {
        ...
        this.__data.typeReference = Array.isArray(value)
    ...
    Object.defineProperty(this, 'period', {
      ...
      set: value => {
        ...
        this.__data.period = Array.isArray(value)
    ...
    Object.defineProperty(this, 'usePeriod', {
      ...
      set: value => {
        ...
        let Period = require('./period.js')
        this.__data.usePeriod = Array.isArray(value)
          ? value.map(v => new Period(v))
          : [new Period(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      typeReference:
        this.typeReference && this.typeReference.map(v => v.toJSON()),

  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'authority', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.authority = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'site', {
      ...
      set: value => {
        ...
        let Reference = require('./reference.js')
        this.__data.site = Array.isArray(value)
          ? value.map(v => new Reference(v))
          : [new Reference(value)]
      },
    })
    ...
    Object.defineProperty(this, 'term', {
      ...
      set: value => {
        ...
        this.__data.term = Array.isArray(value)
          ? value.map(v => new ContractTerm(v))
          : [new ContractTerm(value)]
      },
    })
    ...
    Object.defineProperty(this, 'signer', {
      ...
      set: value => {
        ...
        this.__data.signer = Array.isArray(value)
          ? value.map(v => new ContractSigner(v))
          : [new ContractSigner(value)]
      },
    })
    ...
    Object.defineProperty(this, 'legal', {
      ...
      set: value => {
        ...
        this.__data.legal = Array.isArray(value)
          ? value.map(v => new ContractLegal(v))
          : [new ContractLegal(value)]
      },
    })
    ...
    Object.defineProperty(this, 'rule', {
      ...
      set: value => {
        ...
        this.__data.rule = Array.isArray(value)
          ? value.map(v => new ContractRule(v))
          : [new ContractRule(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      instantiatesCanonical:
        this.instantiatesCanonical && this.instantiatesCanonical.toJSON(),
      _instantiatesUri: this._instantiatesUri && this._instantiatesUri.toJSON(),
      instantiatesUri: this.instantiatesUri,
      contentDerivative:
        this.contentDerivative && this.contentDerivative.toJSON(),
      ...
      topicCodeableConcept:
        this.topicCodeableConcept && this.topicCodeableConcept.toJSON(),
      topicReference: this.topicReference && this.topicReference.toJSON(),
      type: this.type && this.type.toJSON(),
      subType: this.subType && this.subType.map(v => v.toJSON()),
      contentDefinition:
        this.contentDefinition && this.contentDefinition.toJSON(),
      term: this.term && this.term.map(v => v.toJSON()),
      supportingInfo:
        this.supportingInfo && this.supportingInfo.map(v => v.toJSON()),
      relevantHistory:
        this.relevantHistory && this.relevantHistory.map(v => v.toJSON()),
      ...
      legallyBindingAttachment:
        this.legallyBindingAttachment && this.legallyBindingAttachment.toJSON(),
      legallyBindingReference:
        this.legallyBindingReference && this.legallyBindingReference.toJSON(),
    }
  }
}

...
module.exports = class NutritionOrder {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'instantiates', {
      ...
      set: value => {
        ...
        this.__data.instantiates = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      allergyIntolerance:
        this.allergyIntolerance && this.allergyIntolerance.map(v => v.toJSON()),
      foodPreferenceModifier:
        this.foodPreferenceModifier &&
        this.foodPreferenceModifier.map(v => v.toJSON()),
      excludeFoodModifier:
        this.excludeFoodModifier &&
        this.excludeFoodModifier.map(v => v.toJSON()),

  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'implementation', {
      ...
      set: value => {
        ...
        this.__data.implementation = new CapabilityStatementImplementation(
          value
        )
      },
    })
    ...
    Object.defineProperty(this, 'patchFormat', {
      ...
      set: value => {
        ...
        this.__data.patchFormat = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'implementationGuide', {
      ...
      set: value => {
        ...
        this.__data.implementationGuide = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
  ...
  toJSON() {
    return {
      ...
      _implementationGuide:
        this._implementationGuide && this._implementationGuide.toJSON(),

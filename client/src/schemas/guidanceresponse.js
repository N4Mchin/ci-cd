...
module.exports = class GuidanceResponse {
  ...
  toJSON() {
    return {
      ...
      requestIdentifier:
        this.requestIdentifier && this.requestIdentifier.toJSON(),
      ...
      moduleCodeableConcept:
        this.moduleCodeableConcept && this.moduleCodeableConcept.toJSON(),
      ...
      evaluationMessage:
        this.evaluationMessage && this.evaluationMessage.map(v => v.toJSON()),
      outputParameters: this.outputParameters && this.outputParameters.toJSON(),
      result: this.result && this.result.toJSON(),
      dataRequirement:
        this.dataRequirement && this.dataRequirement.map(v => v.toJSON()),
    }
  }
}

...
module.exports = class ChargeItemDefinition {
  constructor(opts) {
    ...
    Object.defineProperty(this, 'derivedFromUri', {
      ...
      set: value => {
        ...
        this.__data.derivedFromUri = Array.isArray(value)
          ? value.map(v => v)
          : [value]
      },
    })
    ...
    Object.defineProperty(this, 'propertyGroup', {
      ...
      set: value => {
        ...
        this.__data.propertyGroup = Array.isArray(value)
          ? value.map(v => new ChargeItemDefinitionPropertyGroup(v))
          : [new ChargeItemDefinitionPropertyGroup(value)]
      },
    })
  ...
  toJSON() {
    return {
      ...
      applicability:
        this.applicability && this.applicability.map(v => v.toJSON()),
      propertyGroup:
        this.propertyGroup && this.propertyGroup.map(v => v.toJSON()),
    }
  }
}

...
module.exports = class EncounterHospitalization {
  ...
  toJSON() {
    return {
      ...
      dietPreference:
        this.dietPreference && this.dietPreference.map(v => v.toJSON()),
      specialCourtesy:
        this.specialCourtesy && this.specialCourtesy.map(v => v.toJSON()),
      specialArrangement:
        this.specialArrangement && this.specialArrangement.map(v => v.toJSON()),

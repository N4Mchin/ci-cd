...
class Contact extends React.Component {
  ...
  componentDidMount() {
    ...
    const CONTACT_VALUESET =
      ...
      this.props.reception.Valuesets['patient-contact-relationship']
          ...
          >
            ...
            >
              {getFieldDecorator('relatedPersonType', {
                ...
                <Select
                  data-cy="contact-relatedPersonType"
                  showSearch
            ...
            >
              ...
              })(<Input data-cy="contact-contactNumber" disabled={!this.state.editMode} />)}
            </Form.Item>
            ...
            >
              ...
              })(<Input data-cy="contact-email" disabled={!this.state.editMode} />)}
            </Form.Item>
          </Form>
        </div>
      </div>
...
function onFieldsChange(props, changedFields, allFields) {
  ...
  const CONTACT_VALUESET =
    props.reception.Valuesets['patient-contact-relationship']

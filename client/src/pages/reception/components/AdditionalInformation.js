...
const AdditionalInformation = props => {
  ...
  useEffect(() => {
    ...
    const [COUNTRY_DESIGNATION, ADMINISTRATIVE_GENDER_DESIGNATION] = [
      props.reception.Valuesets['country-values-mn'],
      props.reception.Valuesets['administrative-gender'],
...
function onFieldsChange(props, changedFields, allFields) {
  const countryValues =
    props.reception.Valuesets && props.reception.Valuesets['country-values-mn']

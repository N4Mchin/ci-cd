...
const NationalIdentificationNumberInput = props => {
  ...
  const [NINumValue, setNINumValue] = useState(props.value ? props.value : '')
...
const NameInput = props => {
  ...
  const [nameValue, setNameValue] = useState(props.value ? props.value : '')
  ...
  const onBlur = () => {
    setNameValue(nameValue && nameValue.trim())
  }
...
const MobilePhoneInput = props => {
  const { editMode } = props
  const [phoneValue, setPhoneValue] = useState(props.value ? props.value : '')
            ...
            <Col span={12}>
              ...
              >
                {getFieldDecorator('familyName', {
                  ...
                  <NameInput
                    data-cy="required-familyName"
                    editMode={editMode}
                    value={props.initials && props.initials.familyName}
                  />
                )}
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              ...
              >
                {getFieldDecorator('givenName', {
                  ...
                  <NameInput
                    data-cy="required-givenName"
                    editMode={editMode}
                    value={props.initials && props.initials.givenName}
                  />
                )}
              </Form.Item>
            </Col>
              ...
              >
                {getFieldDecorator('nationalIdentifier', {
                  ...
                  <NationalIdentificationNumberInput
                    data-cy="required-nationalIdentificationNumber"
                    isVerified={isVerified}
                    editMode={editMode}
                    onChangeNationalID={props.onChangeNationalID}
                    value={props.initials && props.initials.NInum}
                  />
                )}
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              ...
              >
                {getFieldDecorator('phoneNumber', {
                  ...
                  <MobilePhoneInput
                    data-cy="required-phoneNumber"
                    editMode={editMode}
                    maxLength={8}
                    value={props.initials && props.initials.mobilePhone}
                  />
                )}
              </Form.Item>
            </Col>

...
@withI18n()
@connect(({ practitionerProfile, loading }) => ({ practitionerProfile, loading }))
class AccountSettings extends PureComponent {
  ...
  handleCancel = e => {
    const { reception } = this.props.practitionerProfile
    this.setState({
      isEditing: false,
      validOldPassword: 'loading',
    })
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      console.log(payload)
      dispatch({
        type: 'practitionerProfile/update',
        payload: payload,
      })
    })
  }
  ...
  handleOldPasswordBlur = e => {
    ...
    this.props
      .dispatch({
        type: 'practitionerProfile/oldPassword',
  ...
  render() {
    ...
    const { reception, modalVisible } = this.props.practitionerProfile

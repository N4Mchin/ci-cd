...
const FormSection = props => {
  ...
  const { VitalSignsFinding } = app.FHIR_CODES.BriefGeneralExamination.include

  const FieldValues = VitalSignsFinding.include
    ...
    form
      ...
      .then(formValues => {
        return props.dispatch({
          type: 'practitioner_patient_profile/vitalSignsFindingAdd',
          payload: {
            stateName: 'briefGeneralExamination',
  ...
  const title = resolveDisplay(VitalSignsFinding, i18n._language)
                  ...
                  <Form.Item>
                    {getFieldDecorator(
                      ...
                      <FormFields
                        ...
                        suffix={FieldValues[fieldKey].unit}

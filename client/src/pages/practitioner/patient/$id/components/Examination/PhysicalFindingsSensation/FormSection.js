...
const FormSection = props => {
  ...
  const FieldValues = PhysicalFindingsSensation.include
    ...
    form
      ...
      .then(formValues => {
        return props.dispatch({
          type: 'practitioner_patient_profile/physicalFindingsSensationAdd',
          payload: {
  ...
  const title = resolveDisplay(PhysicalFindingsSensation, i18n._language)

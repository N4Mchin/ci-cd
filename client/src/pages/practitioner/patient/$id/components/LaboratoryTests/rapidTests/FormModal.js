  ...
  const onSubmit = () => {
    ...
    return props.form
      ...
      .then(values => {
        ...
        const payload = {
          testCode: props.app.FHIR_CODES.UncategorizedTests.RapidTests,
      ...
      <ModuleBox title={Title}>
        ...
        >
          <Row gutter={24}>
            <Col span={12}>
              <Row>
                {Object.keys(RapidTestInclude).map((testKey, index) => {
                  let test
                  try {
                    ...
                    <Col span={24}>
                      <Form.Item labelCol={0} wrapperCol={24}>
                        {getFieldDecorator(testKey, {
                          ...
                          <QualitativeTestResultInput test={test} key={index} />
                        )}
                      </Form.Item>
                    </Col>
                  )

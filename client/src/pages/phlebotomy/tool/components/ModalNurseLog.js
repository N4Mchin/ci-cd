...
const Title = (
  <Text>
    <Trans>
      <strog>Нэгдсэн сангаас хайх</strog>
    </Trans>
  </Text>
)
...
const Title2 = (
  <Text>
    <Trans>
      <strog>Нэмэгдсэн барааны жагсаалт</strog>
    </Trans>
  </Text>
)

const ModalNurseLog = props => {
  ...
  return (
    ...
    >
      <span style={{ fontSize: '14px', textTransform: 'uppercase' }}>
        <strong>Сувилагчийн хэрэгсэл</strong> нэмж бүртгэх
      </span>
...
export default connect(({ app, phlebotomy, loading }) => ({
  ...
  phlebotomy,
  loading,
}))(withI18n()(Form.create()(ModalNurseLog)))

//created Sanjaasuren.E
//2020-04-08
//modified 2020-05-08 Sanjaasure.E

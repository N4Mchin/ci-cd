...
@withI18n()
@connect(({ admin_profile, loading }) => ({ admin_profile, loading }))
class AccountSettings extends PureComponent {
  ...
  handleCancel = e => {
    const { admin } = this.props.admin_profile
    this.setState({
      isEditing: false,
      validOldPassword: 'loading',
    })
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      if (
        ...
        payload.lastName === admin.lastName &&
        payload.email === admin.email &&
        payload.mobile === admin.mobile &&
        payload.profession === admin.profession &&
  ...
  handleOldPasswordBlur = e => {
    ...
    this.props
      .dispatch({
        type: 'admin_profile/oldPassword',
  ...
  render() {
    const { loading, form, i18n, admin_profile } = this.props
    const { getFieldDecorator, getFieldsValue } = form

    const { admin = {}, modalVisible } = admin_profile
    console.log(admin)
                  ...
                  <div style={{ display: 'flex', flexFlow: 'column wrap' }}>
                    ...
                    >
                      {getFieldDecorator('oldPassword', {
                        // initialValue: admin.identifier[0].value,
                        rules: [
                          {
                            required: false,

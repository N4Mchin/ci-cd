...
// import TestResultWrapper from '../PrintTestResult/TestResultWrapper'
...
const ModalSendResult = props => {
  ...
  useEffect(() => {
    const { patient } = props.laboratory_patientProfile
  ...
  }, [props.laboratory_patientProfile.patient])
    ...
    props.form
      ...
      .then(pdfDocument => {
        ...
        return props.dispatch({
          type: 'laboratory_patientProfile/sendResultViaEmail',
          payload: {
            doc: pdfDocument,
            emails: emails,

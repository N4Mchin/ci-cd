...
const ModalEdit = props => {
  ...
  const { CancellableLabTests } = props.laboratory_patientProfile
  ...
  useEffect(() => {
    ...
    props
      .dispatch({
        type: 'laboratory_patientProfile/queryLabTestOrdersOnly',
        payload: {
    ...
    return props.form
      ...
      .then(values => {
        ...
        return props.dispatch({
          type: 'laboratory_patientProfile/cancelServiceRequest',
          payload: {
            ...values,
            selectedRowData,
          },
      ...
      <ModuleBox title={TitleInformation}>
        <Row>
          ...
          <Col span={12} style={{ textAlign: 'left', fontSize: '14px' }}>
            <span>
              &nbsp;
              {props.app.Practitioner.getOfficialNameString({ short: true })}
              <br />
...
export default connect(({ app, laboratory_patientProfile, loading }) => ({
  ...
  loading,
}))(withI18n()(Form.create()(ModalEdit)))

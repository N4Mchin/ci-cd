...
import DietFinding from '../../../../../components/DietFinding'
...
const PrivateInfoModal = props => {
  ...
  const { onOk, form, i18n, laboratory_patientProfile, ...modalProps } = props
  ...
  useEffect(() => {
    ...
    if (props.visible) {
      props
        .dispatch({
          type: 'laboratory_patientProfile/getPatientInformation',
          payload: { id: props.laboratory_patientProfile.patientId },
        })
        .then(data => {
  ...
  const handleOk = async () => {
    ...
    return props
      .dispatch({
        type: 'laboratory_patientProfile/updatePatientInformationList',
        payload: {
        ...
        <Button
          ...
          loading={
            props.loading.effects[
              'laboratory_patientProfile/updatePatientInformationList'
            ]
          }
        >
          <Trans>Save</Trans>

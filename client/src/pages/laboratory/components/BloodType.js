...
class BloodGroupPanel extends React.Component {
  ...
  componentDidMount() {
    ...
    let [BLOOD_TYPE_DESIGNATION, RHESUS_FACTOR_DESIGNATION] = [
      this.props.laboratory_patientProfile.Valuesets['blood-type-values'],
      this.props.laboratory_patientProfile.Valuesets['rhesus-factor-values'],
...
function onFieldsChange(props, changedFields, allFields) {
  ...
  if (
    ...
    const system =
      props.laboratory_patientProfile.Valuesets['blood-type-values'].compose
        .include[0].system
    console.log(
      props.laboratory_patientProfile.Valuesets['blood-type-values'],
      code
    )
    const display = props.laboratory_patientProfile.Valuesets[
      'blood-type-values'
  ...
  if (
    ...
    const system =
      props.laboratory_patientProfile.Valuesets['rhesus-factor-values'].compose
        .include[0].system
    const display = props.laboratory_patientProfile.Valuesets[

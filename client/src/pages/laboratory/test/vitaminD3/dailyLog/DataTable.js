              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartOne : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartTwo : text,
                      rules: [{ required: false }],
                    }
                  )(<Input />)}
                </Form.Item>
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartThree : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartFour : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartFive : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartSix : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.standartSeven : text,
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.monitorOne : text,
                      rules: [{ required: false }],
                    }
                  )(<Input />)}
                </Form.Item>
              ...
              <div>
                <Form.Item>
                  {getFieldDecorator(
                    ...
                    {
                      initialValue:
                        text === undefined ? control.monitorTwo : text,
                      rules: [{ required: false }],
                    }
                  )(<Input />)}
                </Form.Item>
    ...
    Object.keys(formValues).forEach(formValue => {
      Object.keys(formValues[formValue]).forEach(subFormValue => {
        Object.keys(formValues[formValue][subFormValue]).forEach(child => {
          if (
            ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'].includes(subFormValue) &&
            child === 'day_1'
          ) {
          } else if (['A'].includes(subFormValue) && child === 2) {
          } else {
            form.setFieldsValue({

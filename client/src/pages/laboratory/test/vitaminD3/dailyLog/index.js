...
const DailyLog = () => {
  ...
  return (
    <Board inner>
      ...
      {clickedButton === 'protocol' && <Protocol testName="Vitamin_D3" />}

      {clickedButton === 'reagentConsumption' && (
        <LabTestsReagentConsumption testName="Vitamin_D3" />
      )}
    </Board>
  )
}
...
export default connect(({ laboratory_test_vitaminD3, loading }) => ({

...
export default modelExtend(pageModel, {
  namespace: 'laboratory_test_vitaminD3',
  state: {
    modalData: {},
  },
  ...
  effects: {
    *queryLabTests({ payload = {} }, { call, put, select }) {
      ...
      const localState = yield select(state => state.laboratory_test_vitaminD3)
      const { Vitamin_D3 } = localState
      const loincCode = Vitamin_D3.code.coding.find(
    ...
    *queryLabTestResult({ payload = {} }, { call, put, select }) {
      ...
      if (response && response.success) {
        ...
        const dataSource = controller.generateTableData(
          bundle,
          FHIR_CODES,
          FHIR_CODES.UncategorizedTests.OtherTests.include.Vitamin_D3
        )

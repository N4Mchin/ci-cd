...
const ModalHBVTestProtocolPrint = props => {
      ...
      <Form>
        ...
        >
          <div ref={componentRef}>
            <TestProtocolsHeader title=" HBV-DNA | XCB-ийн идэвхжил тодорхойлох шинжилгээний протокол" />
...
ModalHBVTestProtocolPrint.propTypes = {
...
export default connect(({ app, laboratory_test_viralLoadTests, loading }) => ({
  ...
  loading,
}))(withI18n()(Form.create()(ModalHBVTestProtocolPrint)))

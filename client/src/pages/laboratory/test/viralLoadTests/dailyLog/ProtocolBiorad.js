...
import ProtocolBioradPrint from './ProtocolBioradPrint'
...
const ProtocolBiorad = props => {
  ...
  const [
    ModalProtocolBioradPrintVisible,
    showModalProtocolBioradPrint,
  ] = useState(false)
      ...
      <div className={styles.border}>
        <div className={styles.p}>
          <span style={{ background: 'white' }}>
            <strong>Biorad CFX-96 Dx</strong> ПРТОКОЛ
          </span>
        </div>
        <Form
          layout="horizontal"
              ...
              <Row gutter={[8, 8]} style={{ marginTop: '35px' }}>
                ...
                <Col span={24}>
                  <Button
                    type="primary"
                    block
                    onClick={() => showModalProtocolBioradPrint(true)}
                  >
        ...
        <ProtocolBioradPrint
          visible={ModalProtocolBioradPrintVisible}
          onCancel={() => showModalProtocolBioradPrint(false)}
...
)(withI18n()(Form.create()(ProtocolBiorad)))

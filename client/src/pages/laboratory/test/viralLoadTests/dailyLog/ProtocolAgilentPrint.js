...
const ProtocolAgilentPrint = props => {
  ...
  const protocolColumns = [
    ...
    {
      title: <p>Аппарат асаасан цаг</p>,
      dataIndex: 'timeWhenTheApparatusIsTurnedOn',
      key: 'timeWhenTheApparatusIsTurnedOn',
    },
    {
...
ProtocolAgilentPrint.propTypes = {
...
export default connect(({ app, laboratory_test_viralLoadTests, loading }) => ({
  ...
  loading,
}))(withI18n()(Form.create()(ProtocolAgilentPrint)))

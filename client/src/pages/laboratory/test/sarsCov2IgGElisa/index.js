  ...
  return (
    <Board inner>
      <div style={{ display: 'flex', alignItems: 'flex-end' }}>
        ...
        >
          <span className="bold ">Sars-Cov 2-IgG Elisa</span>
          {' | '}
          <Trans>
...
export default connect(
  ({ app, laboratory_test, laboratory_test_sarsCov2IgGElisa, loading }) => ({
    app,
    laboratory_test,
    laboratory_test_sarsCov2IgGElisa,
    loading,
  })
)(withI18n()(SarsCov2IgGElisa))

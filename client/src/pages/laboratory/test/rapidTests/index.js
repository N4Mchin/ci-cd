...
const RapidTests = props => {
  const { laboratory_test_rapidTests, dispatch, location, loading } = props
  const { pathname } = location
  const {
    modalRapidTestEverydayProtocolVisible,
    modalRapidTestProtocolVisible,
  ...
  return (
    <Board inner>
      <div style={{ display: 'flex', alignItems: 'flex-end' }}>
        ...
        >
          <span className="bold">RAPID</span>
          {' | '}
          <Trans>

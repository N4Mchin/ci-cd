...
class AccountSettings extends PureComponent {
  ...
  // handleCancel = e => {
  //   const { reception } = this.props.labTechnicianProfile
  //   this.setState({
  //     isEditing: false,
  //     validOldPassword: 'loading',
  //   })
  ...
  handleSubmit = e => {
    const { labTechnician } = this.props.labTechnicianProfile
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      console.log(payload)
      dispatch({
        type: 'labTechnicianProfile/update',
        payload: payload,
      })
    })
  }
  ...
  handleOldPasswordBlur = e => {
    ...
    this.props
      .dispatch({
        type: 'labTechnicianProfile/oldPassword',
  ...
  render() {
    ...
    const { labTechnician, modalVisible } = this.props.labTechnicianProfile
                  ...
                  <div style={{ display: 'flex', flexFlow: 'column wrap' }}>
                    ...
                    >
                      {getFieldDecorator('lastName', {
                        initialValue: labTechnician.lastName,
                        rules: [
                          {
                            required: true,
                    ...
                    >
                      {getFieldDecorator('email', {
                        initialValue: labTechnician.email,
                        rules: [
                          {
                            type: 'email',
                    ...
                    >
                      {getFieldDecorator('position', {
                        initialValue: labTechnician.position,
                        rules: [
                          {
                            required: true,
                  ...
                  <div style={{ display: 'flex', flexFlow: 'column wrap' }}>
                    ...
                    >
                      {getFieldDecorator('firstName', {
                        initialValue: labTechnician.firstName,
                        rules: [
                          {
                            required: true,
                    ...
                    >
                      {getFieldDecorator('mobile', {
                        initialValue: labTechnician.mobile,
                        rules: [
                          {
                            required: true,
                            message: i18n.t`WarningInputPhoneNumber`,
                    ...
                    >
                      {getFieldDecorator('profession', {
                        initialValue: labTechnician.profession,
                        rules: [
                          {
                            required: true,
...
AccountSettings.propTypes = {
  labTechnician: PropTypes.object,

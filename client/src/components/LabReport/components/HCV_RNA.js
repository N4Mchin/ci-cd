...
const Title = (
  <div style={{ textAlign: 'center', marginTop: '40px', marginBottom: '40px' }}>
    <Trans id={'HCV-RNA qPCR analysis'} />
  </div>
)
    ...
    props
      ...
      .then(data => {
        ...
        const {
          unit,
          display,
        } = props.app.FHIR_CODES.UncategorizedTests.ViralLoadTests.include.HCV_RNA
      ...
      {!loadingData && (
        <div className={styles.container}>
          <BlankHeader
            ...
            deviceInfo={'Cepheid GeneXpert XVI full automatic system'}
          />
